...
<html
  ...
  <head>
    ...
    <title>Forgot Password | RoomGate</title>

    <meta name="description" content="RoomGate password reset" />
            ...
            <div class="card-body">
              <div class="app-brand justify-content-center mb-6">
                <a href="{{ url('/') }}" class="app-brand-link">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">RoomGate</span>
                </a>
              </div>
              <h4 class="mb-1">Forgot your password?</h4>
              <p class="mb-6">Enter your email and we will send reset instructions</p>
