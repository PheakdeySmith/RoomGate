...
class SendSubscriptionTrialEndingNotifications
{
    public function __construct(private readonly NotificationService $notifications)
    {
    }

    public function handle(SubscriptionTrialEndingSoon $event): void
    {
        ...
        foreach ($recipients as $owner) {
            ...
            $this->notifications->queue(
                ...
                [
                    'dedupe_key' => 'subscription-trial-ending-'.$subscription->id.'-user-'.$owner->id.'-'.optional($subscription->trial_ends_at)->format('Ymd'),
                    'metadata' => [
