...
@section('title', 'Demo: Roles - Apps | Vuexy - Bootstrap Dashboard PRO')
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <p class="mb-6">
                ...
                assigned role an Coreistrator can have access to what user needs.
              </p>
              <!-- Role cards -->
              <div class="row g-6">
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                          ...
                          <li
                            ...
                            title="Kaith D'souza"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/3.png" alt="Avatar" />
                          </li>
                        </ul>
                      </div>
                      <div class="d-flex justify-content-between align-items-end">
                        <div class="role-heading">
                          <h5 class="mb-1">Coreistrator</h5>
                          <a
                            href="javascript:;"
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                          <li
                            ...
                            title="Jimmy Ressula"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/4.png" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                            ...
                            title="John Doe"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/1.png" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                            ...
                            title="Kristi Lawker"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/2.png" alt="Avatar" />
                          </li>
                          <li class="avatar">
                            <span
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                          ...
                          <li
                            ...
                            title="Rishi Swaat"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/9.png" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                          <li
                            ...
                            title="Kim Merchent"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/10.png" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                            ...
                            title="Sam D'souza"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{ asset('assets/assets') }}/img/avatars/13.png" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                ...
                <div class="col-12">
                  ...
                  <p class="mb-0">Find all of your company’s Coreistrator accounts and their associate roles.</p>
                </div>
                <div class="col-12">
                  <!-- Role Table -->
                  <div class="card">
...
@endsection
@push('page-scripts')
  <script src="{{ asset('assets/assets') }}/js/app-access-roles.js"></script>
  <script src="{{ asset('assets/assets') }}/js/modal-add-role.js"></script>
@endpush
