...
@section('title', 'Demo: Invoice (Print version) - Pages | Vuexy - Bootstrap Dashboard PRO')
@push('page-styles')
...
<div class="invoice-print p-12">
      ...
      <div class="table-responsive border border-bottom-0 border-top-0 rounded">
        <table class="table m-0">
          ...
          <tbody>
            <tr>
              <td>Vuexy Core Template</td>
              <td>HTML Core Template</td>
              <td>$32</td>
              <td>1</td>
              <td>$32.00</td>
            </tr>
            <tr>
              <td>Frest Core Template</td>
              <td>Angular Core Template</td>
              <td>$22</td>
              <td>1</td>
              <td>$22.00</td>
            </tr>
            <tr>
              <td>Apex Core Template</td>
              <td>HTML Core Template</td>
              <td>$17</td>
              <td>2</td>
              <td>$34.00</td>
            ...
            <tr>
              <td>Robust Core Template</td>
              <td>React Core Template</td>
              <td>$66</td>
              <td>1</td>
              <td>$66.00</td>
            </tr>
