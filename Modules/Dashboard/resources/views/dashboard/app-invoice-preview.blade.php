...
@section('title', 'Demo: Preview - Invoice | Vuexy - Bootstrap Dashboard PRO')
@push('page-styles')
                  ...
                  <div class="card invoice-preview-card p-sm-12 p-6">
                    ...
                    <div class="table-responsive border border-bottom-0 border-top-0 rounded">
                      <table class="table m-0">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-nowrap text-heading">Vuexy Core Template</td>
                            <td class="text-nowrap">HTML Core Template</td>
                            <td>$32</td>
                            <td>1</td>
                            <td>$32.00</td>
                          </tr>
                          <tr>
                            <td class="text-nowrap text-heading">Frest Core Template</td>
                            <td class="text-nowrap">Angular Core Template</td>
                            <td>$22</td>
                            <td>1</td>
                            <td>$22.00</td>
                          </tr>
                          <tr>
                            <td class="text-nowrap text-heading">Apex Core Template</td>
                            <td class="text-nowrap">HTML Core Template</td>
                            <td>$17</td>
                            <td>2</td>
                            <td>$34.00</td>
                          ...
                          <tr>
                            <td class="text-nowrap text-heading">Robust Core Template</td>
                            <td class="text-nowrap">React Core Template</td>
                            <td>$66</td>
                            <td>1</td>
                            <td>$66.00</td>
                          </tr>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <button
                        ...
                        <span class="d-flex align-items-center justify-content-center text-nowrap"
                          ><i class="icon-base ti tabler-currency-dollar icon-xs me-2"></i>Add Payment</span
                        >
                      </button>
                    </div>
                  </div>
                  ...
                  <form>
                    ...
                    <div class="mb-6">
                      ...
                      <input
                        ...
                        class="form-control"
                        id="invoice-subject"
                        value="Invoice of purchased Core Templates"
...
@push('page-scripts')
  ...
  <script src="{{ asset('assets/assets') }}/js/offcanvas-add-payment.js"></script>
  <script src="{{ asset('assets/assets') }}/js/offcanvas-send-invoice.js"></script>
@endpush
