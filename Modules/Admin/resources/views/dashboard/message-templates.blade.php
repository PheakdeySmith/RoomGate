...
@section('title', 'Message Templates | RoomGate Admin')
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex gap-2">
                    ...
                    <form method="POST" action="{{ route('admin.message-templates.destroy', $template) }}" data-confirm="Delete this template?">
                      @csrf
                      @method('DELETE')
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (editModal) {
        editModal.addEventListener('show.bs.modal', function (event) {
          ...
          form.action = `{{ route('admin.message-templates.update', 'TEMPLATE_ID') }}`.replace('TEMPLATE_ID', id);
      ...
      if (testModal) {
        testModal.addEventListener('show.bs.modal', function (event) {
          ...
          form.action = `{{ route('admin.message-templates.test', 'TEMPLATE_ID') }}`.replace('TEMPLATE_ID', id);
        });
      }
    });
  </script>
