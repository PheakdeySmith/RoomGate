...
<div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                ...
                <!-- User Content -->
                <div class="col-xl-8 col-lg-7 order-0 order-md-1" data-ajax-container="user-view" data-ajax-container="user-view">
                  <!-- User Pills -->
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2" data-ajax-tabs="user-view" data-ajax-tabs="user-view">
                      <li class="nav-item">
                        <a class="nav-link active" data-ajax-link="user-view" data-ajax-link="user-view" href="{{ route('admin.users.account', $user) }}"
                          ><i class="icon-base ti tabler-user-check icon-sm me-1_5"></i>Account</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" data-ajax-link="user-view" href="{{ route('admin.users.security', $user) }}"
                          ><i class="icon-base ti tabler-lock icon-sm me-1_5"></i>Security</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" data-ajax-link="user-view" href="{{ route('admin.users.billing', $user) }}"
                          ><i class="icon-base ti tabler-bookmark icon-sm me-1_5"></i>Billing & Plans</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" data-ajax-link="user-view" href="{{ route('admin.users.notifications', $user) }}"
                          ><i class="icon-base ti tabler-bell icon-sm me-1_5"></i>Notifications</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" data-ajax-link="user-view" href="{{ route('admin.users.connections', $user) }}"
