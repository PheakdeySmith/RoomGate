      ...
      <div class="modal-body">
        <form method="POST" action="{{ route('admin.properties.store') }}" class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" id="propertyType" name="property_type" class="form-control" placeholder="Apartment" />
          </div>
          <div class="col-md-6">
      ...
      <div class="modal-body">
        <form method="POST" id="editPropertyForm" action="" class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" id="editPropertyType" name="property_type" class="form-control" />
          </div>
          <div class="col-md-6">
