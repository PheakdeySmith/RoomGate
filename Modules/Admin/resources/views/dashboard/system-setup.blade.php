...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card mb-6">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('admin.system-setup.utility.update') }}" class="row g-3">
        @csrf
        @method('PUT')
  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="row g-3 mb-3">
        <div class="col-md-6"><div class="alert alert-info mb-0">Latest DB Backup: {{ $latestDbBackup['name'] ?? 'None' }} @if($latestDbBackup) ({{ $latestDbBackup['modified_at'] }}) @endif</div></div>
        <div class="col-md-6"><div class="alert alert-info mb-0">Latest Upload Backup: {{ $latestUploadBackup['name'] ?? 'None' }} @if($latestUploadBackup) ({{ $latestUploadBackup['modified_at'] }}) @endif</div></div>
      </div>
