...
@section('title', 'Admin User View | RoomGate')
@push('page-styles')
              ...
              <div class="row">
                      ...
                      <div class="user-avatar-section">
                        <div class=" d-flex align-items-center flex-column">
                          <img
                            ...
                            src="{{ asset('assets/assets') }}/img/avatars/1.png"
                            height="120"
                            width="120"
                            alt="User avatar" />
                ...
                <div class="col-xl-8 col-lg-7 order-0 order-md-1" data-ajax-container="user-view">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2" data-ajax-tabs="user-view">
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" href="{{ route('admin.users.account', $user) }}"
                          ><i class="icon-base ti tabler-user-check me-1_5 icon-sm"></i>Account</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" href="{{ route('admin.users.security', $user) }}"
                          ><i class="icon-base ti tabler-lock me-1_5 icon-sm"></i>Security</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" data-ajax-link="user-view" href="{{ route('admin.users.billing', $user) }}"
                          ><i class="icon-base ti tabler-bookmark me-1_5 icon-sm"></i>Billing & Plans</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" href="{{ route('admin.users.notifications', $user) }}"
                          ><i class="icon-base ti tabler-bell me-1_5 icon-sm"></i>Notifications</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-ajax-link="user-view" href="{{ route('admin.users.connections', $user) }}"
                          ><i class="icon-base ti tabler-link me-1_5 icon-sm"></i>Connections</a
                        >
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="card-header align-items-center">
                      ...
                      <div class="card-action-element">
                        <button
                          ...
                          <i class="icon-base ti tabler-plus icon-14px me-1_5"></i>Add Card
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="card-information">
                              <img
                                ...
                                src="{{ asset('assets/assets') }}/img/icons/payments/mastercard.png"
                                alt="Master Card" />
                            ...
                            <div class="d-flex flex-column text-start text-lg-end">
                              <div class="d-flex order-sm-0 order-1">
                                <button
                                  ...
                                  data-bs-toggle="modal"
                                  data-bs-target="#editCCModal" data-bs-toggle="modal">
                                  Edit
                                </button>
                                <button class="btn btn-sm btn-label-danger">Delete</button>
                              </div>
                              <small class="mt-sm-4 mt-2 order-sm-1 order-0 text-sm-end mb-2"
                                >Card expires at 12/24</small
                              >
                            </div>
                          </div>
                        </div>
                        <div class="cardMaster border p-6 rounded mb-4">
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="card-information">
                              <img
                                class="mb-2 img-fluid"
                                src="{{ asset('assets/assets') }}/img/icons/payments/visa.png"
                                alt="Master Card" />
                        ...
                        <div class="cardMaster border p-6 rounded">
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="card-information">
                              <img
                                class="mb-2 img-fluid"
                                src="{{ asset('assets/assets') }}/img/icons/payments/american-express-logo.png"
                                alt="Visa Card" />
                              <div class="d-flex align-items-center mb-2">
                  ...
                  <div class="card card-action mb-4">
                    <div class="card-header align-items-center flex-wrap gap-2">
                      ...
                      <div class="card-action-element">
                        <button
                          class="btn btn-sm btn-primary edit-address"
                          type="button"
                          data-bs-toggle="modal"
                          data-bs-target="#addNewAddress">
                          <i class="icon-base ti tabler-plus icon-14px me-1_5"></i>Edit address
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
...
@push('page-scripts')
  ...
  <script src="{{ asset('assets/assets') }}/js/modal-edit-user.js"></script>
  <script src="{{ asset('assets/assets') }}/js/modal-edit-cc.js"></script>
  <script src="{{ asset('assets/assets') }}/js/modal-add-new-cc.js"></script>
  <script src="{{ asset('assets/assets') }}/js/modal-add-new-address.js"></script>
  <script src="{{ asset('assets/assets') }}/js/app-user-view.js"></script>
  <script src="{{ asset('assets/assets') }}/js/app-user-view-billing.js"></script>
    <script src="{{ asset('assets/assets') }}/js/app-user-view-account.js"></script>
  <script src="{{ asset('assets/assets') }}/js/app-user-view-security.js"></script>
