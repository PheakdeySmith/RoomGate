                ...
                <div class="col-xl-8 col-lg-7 order-0 order-md-1" data-ajax-container="user-view">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2" data-ajax-tabs="user-view">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" data-ajax-link="user-view" href="{{ route('admin.users.security', $user) }}"
                  ...
                  <div class="card mb-6">
                    ...
                    <div class="card-body pt-0">
                      ...
                      <p class="mb-0">
                        ...
                        <a href="{{ route('admin.users.account', $user) }}" class="text-primary">Learn more.</a>
                      </p>
                    </div>
                  </div>
                  <!--/ Two-steps verification -->
                        ...
                        <tbody>
                          <tr>
                            <td class="text-truncate">
                              <i class="icon-base ti tabler-brand-windows icon-md text-info me-4"></i>
                          ...
                          <tr>
                            <td class="text-truncate">
                              <i class="icon-base ti tabler-device-mobile icon-md text-danger me-4"></i>
                          ...
                          <tr>
                            <td class="text-truncate">
                              <i class="icon-base ti tabler-brand-android icon-md text-success me-4"></i>
                          ...
                          <tr>
                            <td class="text-truncate">
                              <i class="icon-base ti tabler-brand-apple icon-md me-4"></i>
...
@push('page-scripts')
  ...
  <script src="{{ asset('assets/assets') }}/js/modal-enable-otp.js"></script>
