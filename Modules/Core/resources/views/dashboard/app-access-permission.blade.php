...
@section('title', 'Demo: Permission - Apps | Vuexy - Bootstrap Dashboard PRO')
@section('content')
...
@endsection
@push('page-scripts')
  <script src="{{ asset('assets/assets') }}/js/app-access-permission.js"></script>
  <script src="{{ asset('assets/assets') }}/js/modal-add-permission.js"></script>
  <script src="{{ asset('assets/assets') }}/js/modal-edit-permission.js"></script>
@endpush
