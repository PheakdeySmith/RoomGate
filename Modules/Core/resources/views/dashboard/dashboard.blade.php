...
@section("title", "Demo: Dashboard - Analytics | Vuexy - Bootstrap Dashboard PRO")
@section("content")
          ...
          <div class="swiper-wrapper">
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                    <img src="{{ asset("assets/assets") }}/img/illustrations/card-website-analytics-1.png"
            ...
            <div class="swiper-slide">
              <div class="row">
                ...
                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                  <img src="{{ asset("assets/assets") }}/img/illustrations/card-website-analytics-2.png" alt="Website Analytics"
            ...
            <div class="swiper-slide">
              <div class="row">
                ...
                <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1 pt-md-9">
                  <h6 class="text-white mt-0 mt-md-3 mb-4">Revenue
                    Sources</h6>
                  <div class="row">
                    <div class="col-6">
                      <ul class="list-unstyled mb-0">
                ...
                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                  <img src="{{ asset("assets/assets") }}/img/illustrations/card-website-analytics-3.png" alt="Website Analytics"
                    height="150" class="card-website-analytics-img" />
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="row align-items-center g-md-8">
              <div class="col-12 col-md-5 d-flex flex-column">
                ...
                <small class="text-body">You informed of this week
                  compared to last week</small>
              </div>
          ...
          <div class="card-header d-flex justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn btn-text-secondary btn-icon rounded-pill text-body-secondary border-0 me-n1"
                type="button" id="salesByCountry" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                    <div class="me-2">
                      ...
                      <small class="text-body">Direct link
                        click</small>
                    </div>
                    <div class="d-flex align-items-center">
                      <p class="mb-0">1.2k</p>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                    <div class="me-2">
                      ...
                      <small class="text-body">Impact Radius
                        Visits</small>
                    </div>
                    <div class="d-flex align-items-center">
                      <p class="mb-0">342</p>
