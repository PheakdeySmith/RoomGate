...
@section('title', 'Audit Logs | RoomGate')
    ...
    <div class="card-body">
      <form method="GET" class="row g-3 align-items-end">
        ...
        <div class="col-12">
          ...
          <a href="{{ route('core.audit-logs.index', ['tenant' => $tenant->slug]) }}" class="btn btn-label-secondary">Reset</a>
          <a href="{{ route('core.audit-logs.export', ['tenant' => $tenant->slug] + request()->query()) }}" class="btn btn-label-info">Export CSV</a>
        </div>
      </form>
    </div>
  </div>
