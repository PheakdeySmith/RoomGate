...
@section('title', 'Demo: Edit - Invoice | Vuexy - Bootstrap Dashboard PRO')
@push('page-styles')
                  ...
                  <div class="card mb-6">
                    <div class="card-body">
                      ...
                      <button
                        ...
                        <span class="d-flex align-items-center justify-content-center text-nowrap"
                          ><i class="icon-base ti tabler-currency-dollar icon-xs me-1"></i>Add Payment</span
                        >
                      </button>
                    </div>
                  </div>
...
@push('page-scripts')
  ...
  <script src="{{ asset('assets/assets') }}/vendor/libs/jquery-repeater/jquery-repeater.js"></script>
  ...
  <script src="{{ asset('assets/assets') }}/js/app-invoice-edit.js"></script>
@endpush
