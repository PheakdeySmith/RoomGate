                ...
                <nav class="layout-navbar container-xxl navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                            ...
                            @php
                                $authUser = auth()->user();
                                $notificationItems = $authUser
                                    ? $authUser->inAppNotifications()->orderByDesc('created_at')->limit(5)->get()
                                    : collect();
                                $unreadCount = $authUser
                                    ? $authUser->inAppNotifications()->whereNull('read_at')->count()
                                    : 0;
                                $typeStyles = [
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-0">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            @forelse ($notificationItems as $notification)
                                                @php
                                                    ...
                                                    $linkUrl = $notification->link_url ?: route('core.notifications.index');
                                                @endphp
                                                <li class="list-group-item list-group-item-action dropdown-notifications-item {{ $isRead ? 'marked-as-read' : '' }}">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0 dropdown-notifications-actions">
                                                            ...
                                                            <a href="{{ $linkUrl }}" class="dropdown-notifications-archive">
                                                                <span class="icon-base ti tabler-arrow-right"></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </li>
                                    ...
                                    <li class="border-top">
                                        <div class="d-grid p-4">
                                            <a class="btn btn-primary btn-sm d-flex" href="{{ route('core.notifications.index') }}">
